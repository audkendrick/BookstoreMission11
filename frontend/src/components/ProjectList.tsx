  ...
  useEffect(() => {
    const fetchBooks = async () => {
      ...
      const response = await fetch(
        `https://bookprojectkendrickbackend.azurewebsites.net/Book/GetBooks?pageSize=${pageSize}&pageNum=${pageNum}${selectedCategories.length ? `&${categoryParams}` : ""}&sortBy=${sortBy}&sortOrder=${sortOrder}&maxPrice=${maxPrice}`
      );
