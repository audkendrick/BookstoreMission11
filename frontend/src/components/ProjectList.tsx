  ...
  useEffect(() => {
    const fetchBook = async () => {
      ...
      const response = await fetch(
        `https://bookprojectkendrickbackend.azurewebsites.net/Book?pageSize=${pageSize}&pageNum=${pageNum}${selectedCategories.length ? `&${categoryParams}` : ""}&sortBy=${sortBy}&sortOrder=${sortOrder}&maxPrice=${maxPrice}`
      );
